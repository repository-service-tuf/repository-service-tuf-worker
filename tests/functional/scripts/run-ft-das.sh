...
python ${UMBRELLA_PATH}/tests/functional/scripts/rstuf-admin-ceremony.py '{
    ...
    "(online) Choose ONLINEs key type [ed25519/ecdsa/rsa] (ed25519)": "",
    "(online) Enter ONLINEs key id": "f7a6872f297634219a80141caa2ec9ae8802098b07b67963272603e36cc19fd8",
    "(online) Enter ONLINEs public key hash": "9fe7ddccb75b977a041424a1fdc142e01be4abab918dc4c611fbfe4a3360a9a8",
    "Give a name/tag to the key [Optional]": "online v1",
    "Ready to start loading the root keys?": "y",
    "(root 1) Choose roots key type [ed25519/ecdsa/rsa] (ed25519)": "ed25519",
    "(root 1) Enter the roots private key path": "tests/files/key_storage/JanisJoplin.key",
    "(root 1) Enter the roots private key password": "strongPass",
    ...
    "(root 2) Choose roots key type [ed25519/ecdsa/rsa] (ed25519)": "",
    "(root 2) Enter roots key id": "800dfb5a1982b82b7893e58035e19f414f553fc08cbb1130cfbae302a7b7fee5",
    "(root 2) Enter ONLINEs public key hash": "7098f769f6ab8502b50f3b58686b8a042d5d3bb75d8b3a48a2fcbc15a0223501",
    ...
    "(root 3) Choose roots key type [ed25519/ecdsa/rsa] (ed25519)": "",
    "(root 3) Enter roots key id": "7641c1c12b98c18cfbadd87209fe190072e712cc0e14e13fe83febc2150f7520",
    "(root 3) Enter ONLINEs public key hash": "414af03cbaae93b5f44363f0bf757421e64bd892b891b0dff3ad6af5eb3a3038",
...
python ${UMBRELLA_PATH}/tests/functional/scripts/rstuf-admin-metadata-sign.py '{
    ...
    "Choose roots key type [ed25519/ecdsa/rsa] (ed25519)": "",
