...
class TestApp:
    ...
    @pytest.mark.parametrize(
        ...
        "chunk_size_cfg, expected_result, expected_log_msg",
        [
    ...
    def test_bump_online_roles_lock(
        self,
        app,
        caplog,
        expired,
        ...
        app._update_snapshot_timestamp = pretend.call_recorder(lambda *a: None)
        app._update_snapshot_timestamp.s = pretend.call_recorder(
            lambda *a: None
        )
        app._end_bor_chain_callback = pretend.call_recorder(lambda *a: None)
